...
fn test_parse_trace_file_connections() {
    ...
    writeln!(
        file,
        "2025-05-01 10:00:00.000  info anydesk - Incoming connection from 111 222 333"
    )
    .unwrap();
    writeln!(
        file,
        "2025-05-01 10:05:00.000  info anydesk - Connecting to 999 888 777"
    )
    .unwrap();
...
fn test_parse_trace_file_invalid_date() {
    ...
    writeln!(
        file,
        "INVALID_DATE  info anydesk - Incoming connection from 111 222 333"
    )
    .unwrap();
